...
class CityService(private val connection: Connection, private val dispatcher: CoroutineDispatcher = Dispatchers.IO) {
    companion object {
    ...
    // Create new city
    suspend fun create(city: City): Int = withContext(dispatcher) {
    ...
    // Read a city
    suspend fun read(id: Int): City = withContext(dispatcher) {
    ...
    // Update a city
    suspend fun update(id: Int, city: City) = withContext(dispatcher) {
