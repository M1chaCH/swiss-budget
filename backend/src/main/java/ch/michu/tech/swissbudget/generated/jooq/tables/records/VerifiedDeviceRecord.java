...
public class VerifiedDeviceRecord extends UpdatableRecordImpl<VerifiedDeviceRecord> implements Record3<String, String, String> {
     ...
     */
    public VerifiedDeviceRecord(String id, String userId, String userAgent) {
        super(VerifiedDevice.VERIFIED_DEVICE);
    ...
    @Override
    public VerifiedDeviceRecord value1(String value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public VerifiedDeviceRecord values(String value1, String value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
