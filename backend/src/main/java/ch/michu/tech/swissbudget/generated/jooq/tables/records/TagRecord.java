...
public class TagRecord extends UpdatableRecordImpl<TagRecord> implements Record6<String, String, String, String, String, Boolean> {
     ...
     */
    public TagRecord(String id, String icon, String color, String name, String userId, Boolean defaultTag) {
        super(Tag.TAG);
    ...
    @Override
    public TagRecord values(String value1, String value2, String value3, String value4, String value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
