...
public class RegisteredUser extends TableImpl<RegisteredUserRecord> {
     ...
     */
    public final TableField<RegisteredUserRecord, String> MAIL_PASSWORD = createField(DSL.name("mail_password"), SQLDataType.VARCHAR(250),
        this, "");
    /**
    ...
    public final TableField<RegisteredUserRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"),
        SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this,
        "");
    /**
     ...
     */
    public final TableField<RegisteredUserRecord, Boolean> DEMO_USER = createField(DSL.name("demo_user"),
        SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "");
