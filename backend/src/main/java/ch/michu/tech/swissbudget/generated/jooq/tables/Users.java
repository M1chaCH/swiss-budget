...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, Integer> ID = createField(DSL.name("id"),
        SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    /**
     * The column <code>public.users.mail</code>.
     */
    public final TableField<UsersRecord, String> MAIL = createField(DSL.name("mail"),
        SQLDataType.VARCHAR(250).nullable(false), this, "");
    /**
     * The column <code>public.users.password</code>.
     */
    public final TableField<UsersRecord, String> PASSWORD = createField(DSL.name("password"),
        SQLDataType.VARCHAR(250).nullable(false), this, "");
    /**
     * The column <code>public.users.username</code>.
     */
    public final TableField<UsersRecord, String> USERNAME = createField(DSL.name("username"),
        SQLDataType.VARCHAR(250), this, "");
    /**
     * The column <code>public.users.disabled</code>.
     */
    public final TableField<UsersRecord, Boolean> DISABLED = createField(DSL.name("disabled"),
     ...
     */
    public final TableField<UsersRecord, LocalDateTime> CREATED_AT = createField(
    ...
    public final TableField<UsersRecord, Boolean> VERIFIED = createField(DSL.name("verified"),
        ...
        this, "");
    /**
     * The column <code>public.users.last_online</code>.
     */
    public final TableField<UsersRecord, LocalDateTime> LAST_ONLINE = createField(
        DSL.name("last_online"), SQLDataType.LOCALDATETIME(6).nullable(false)
            .defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<UniqueKey<UsersRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.USERS_MAIL_KEY);
    }
    ...
    public <U> SelectField<U> mapping(
        Function8<? super Integer, ? super String, ? super String, ? super String, ? super Boolean, ? super LocalDateTime, ? super Boolean, ? super LocalDateTime, ? extends U> from) {
